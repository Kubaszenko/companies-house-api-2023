    ...
    searchAllBy(query, itemCount){
        return new Promise(
            (resolve, reject) => {
                axios({
                    method:'get',
                    url: 'https://stream.companieshouse.gov.uk/search',
                    params: {
                        q: query,
                        items_per_page: itemCount
                    },
    ...
    searchForOfficerBy(query, itemCount){
        return new Promise(
            (resolve, reject) => {
                axios({
                    method:'get',
                    url: 'https://stream.companieshouse.gov.uk/search/officers',
                    params: {
                        q: query,
                        items_per_page: itemCount
                    },
    ...
    searchForDisqualifiedOfficerBy(query, itemCount){
        return new Promise(
            (resolve, reject) => {
                axios({
                    method:'get',
                    url: 'https://stream.companieshouse.gov.uk/search/disqualified-officers',
                    params: {
                        q: query,
                        items_per_page: itemCount
                    },
